...
public class CustomPluginAdapter extends PluginAdapter {
    ...
    public CompilationUnit getServiceClazz(IntrospectedTable introspectedTable) {
        ...
        FullyQualifiedJavaType superClassType = new FullyQualifiedJavaType("BaseService<" + daoName + "," + clazzName + ">");
        FullyQualifiedJavaType impClassType = new FullyQualifiedJavaType("com.fit.base.BaseService");
    ...
    public boolean clientGenerated(Interface interfaze, TopLevelClass topLevelClass, IntrospectedTable introspectedTable) {
        ...
        FullyQualifiedJavaType imp = new FullyQualifiedJavaType("com.fit.base.BaseDao");
