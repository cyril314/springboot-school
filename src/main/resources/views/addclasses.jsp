    ...
    <div class="main-content">
        <div class="page-content">
            <div class="page-header position-relative">
                <h1><small> <i class="icon-list-alt"></i> 添加班级 </small></h1>
            </div>
            <div class="row-fluid">
                <div class="span12">
                    <!--PAGE CONTENT BEGINS-->
                    <form action="addclasses" id="addclasses" class="form-horizontal" method="post">
                        <div class="control-group">
                            ...
                            <div class="controls">
                                ...
                                <span class="help-inline"><c:if test="${param.notice==null}">例：三年级二班编号为302</c:if>  <font
                                        color="red"><c:if test="${param.notice!=null}">${param.notice}</c:if></font></span>
                            </div>
                        </div>
                        <div class="control-group">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" value="${param.headteacher}" name="headteacher" id="headteacher"
                                       placeholder="班主任姓名">*
                            </div>
                        </div>
                        <div class="form-actions">
                            <button class="btn btn-info" id="add" type="button">
                                <i class="icon-ok bigger-110"></i>添加班级
                            </button>
                            &nbsp; &nbsp; &nbsp;
                            <button class="btn btn-info" type="button" onclick="location.href='${ctx}/manager/classes'">
