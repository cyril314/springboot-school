    ...
    <div class="main-content">
        ...
        <div class="page-content">
            <div class="page-header position-relative">
                <h1><small> <i class="icon-list-alt"></i> 管理学生 </small></h1>
            </div>
            <div class="row-fluid">
                <div class="span12">
                    <!--PAGE CONTENT BEGINS-->
                    <label> 管理 <b>${cls.name}</b> 学生（班主任：${cls.headteacher }） </label>
                    <br>
                    <form class="form-inline" id="savestudent" method="post" action="addstudent">
                        ...
                        <button class="btn btn-small btn-info" id="addstudent" type="button">
                            <i class="icon-ok"></i> 添加学生
                        </button>
                        <button class="btn btn-small btn-info" onclick="location.href='${ctx}/manager/classes'" type="button">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="#myModal" role="button"
                                       onclick="setvalue('${student.id}','${student.name}','${student.remark}')"
                                       class="btn  btn-mini btn-info" data-toggle="modal"><i class="icon-edit"></i>编辑</a>
                                    <button class="btn btn-mini btn-danger"
                                            onclick="if(window.confirm('确认删除学生${student.name}？')==true)location.href='${ctx}/manager/deletestudent?studentid=${student.id}&classid=${student.classId}'">
