                    ...
                    <div class="row-fluid">
                        <div class="center">
                            <h1>
                                ...
                                <span class="red">&nbsp;校联网</span>
                                <span class="white"></span>
                            </h1>
                            <h4 class="blue">&copy; <a href="#" target="_blank">小联同学</a></h4>
                        </div>
                    </div>
                            ...
                            <div id="login-box" class="login-box visible widget-box no-border">
                                <div class="widget-body">
                                    <div class="widget-main">
                                        ...
                                        <div class="social-or-login center"><span class="bigger-110">校联网(school)</span></div>
                                        <div class="social-login center">
                                            <img alt="校联网" src="${ctx}/assets/img/qrcode.jpeg" style="height: 100px;width: 100px;" >
                                        </div>
                                    </div><!--/widget-main-->
                                </div><!--/widget-body-->
                            </div><!--/login-box-->
