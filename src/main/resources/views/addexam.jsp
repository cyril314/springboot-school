            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <form action="addexammark" id="addexammark" class="form-horizontal" method="post">
                        ...
                        <label> &nbsp;&nbsp;&nbsp;录入 <b>${exam.classid}</b> 班 <b>${exam.course}</b> 考试成绩 （
                            满分<b>${exam.fullmarks}</b>分 ） </label>
                        <hr>
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <c:forEach items="${stlist}" var="student" varStatus="sta">
                                <tr>
                                    <td>${student.id }<input type="hidden" name="examMarks[${sta.index}].studentid" value="${student.id}">
                                    </td>
                                    <td>${student.name }<input type="hidden" name="examMarks[${sta.index}].studentname" value="${student.name}">
                                        <input type="hidden" name="examMarks[${sta.index}].classid" value="${student.classid}">
                                    </td>
                        ...
                        <div class="form-actions">
                            ...
                            <button class="btn btn-info" type="button"
                                    onclick="location.href='${ctx}/manager/exams'">
